class ServicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @service.save
        format.html { redirect_to :list_account_services_path, notice: 'Service was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @service.update(service_params)
        format.html { redirect_to :list_account_services_path, notice: 'Service was successfully updated.' }
