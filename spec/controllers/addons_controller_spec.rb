...
describe AddonsController do
  ...
  describe "GET show" do
    it "assigns the requested addon as @addon" do
      addon = Addon.create! valid_attributes
      get :show, {:id => addon.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested addon as @addon" do
      addon = Addon.create! valid_attributes
      get :edit, {:id => addon.to_param}, valid_session
      assigns(:addon).should eq(addon)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Addon" do
        expect {
          post :create, {:addon => valid_attributes}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested addon as @addon" do
        addon = Addon.create! valid_attributes
        put :update, {:id => addon.to_param, :addon => valid_attributes}, valid_session
        assigns(:addon).should eq(addon)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested addon" do
      addon = Addon.create! valid_attributes
      expect {
        delete :destroy, {:id => addon.to_param}, valid_session
      }.to change(Addon, :count).by(-1)
    end
